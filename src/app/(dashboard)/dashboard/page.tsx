...
import { getMetricsWithTrend } from "~/actions/get-metrics";
import { getRecentTasks } from "~/actions/get-tasks";
import { getPendingInvoices } from "~/actions/get-invoices";
...
export default async function DashboardPage() {
        ...
        <Card className="max-w-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground">
              You don&apos;t have any projects yet. Contact your administrator
              to get started.
            </p>
          </CardContent>
        </Card>
  ...
  const [metrics, tasks, invoices] = await Promise.all([
    getMetricsWithTrend(project.id),
    getRecentTasks(project.id, 5),
    getPendingInvoices(project.id),
  ]);
        ...
        <section>
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>
                {metrics
                  ? formatDate(metrics.report_month)
                  : "No data available"}
              </span>
            </div>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-4">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/billing" className="gap-1">
                  View all
                  <ArrowRight className="size-4" />
                </Link>
              </Button>
